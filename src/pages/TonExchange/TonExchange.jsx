  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        <span className={styles.label}>Ви отримуєте (<img src='/toncoin-ton-logo.svg' alt="ton" className={styles.ton} /> TON)</span>
      ...
      <div className={styles.rateInfo}>
        💰 Курс: 1 <img src='/toncoin-ton-logo.svg' alt="ton" className={styles.ton1} />TON  ≈ {currentRate.toFixed(2)} грн ($2.5)
      </div>
